                ...
                <div class="col-md-12 chats pt-3 pl-2 pr-3 pb-3">
                    <ul class="p-0">
                        <#list messages as message>
                            <#if message.getIdToUser() == user.getId()>
                            ...
                            <#else>
                                <li class="receive-msg float-left mb-2">-->
                                    <div class="sender-img">
                                        <img src="${user.getPhoto()}" class="float-left">
                                    </div>
                                    <div class="receive-msg-desc float-left ml-2">
                                        <p class="bg-white m-0 pt-1 pb-1 pl-2 pr-2 rounded">
                                            ${message.getText()}
                                        </p>
                                        <span class="receive-msg-time">${user.getName()},  ${message.getTimeString()}</span>
                                    </div>
                                </li>
                            </#if>
                        </#list>
                ...
                <div class="col-md-12 p-2 msg-box border border-primary">
                    <div class="row">
                        ...
                        <form class="col-md-7 pl-0" method="post">
                            <input type="text" class="border-0" placeholder=" Send message" name="someText"/>
                        </form>
